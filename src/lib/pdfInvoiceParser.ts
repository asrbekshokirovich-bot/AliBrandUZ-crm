...
export function parseInvoiceData(text: string): ParsedInvoice {
  ...
  const invPatterns: RegExp[] = [
    ...
    /[\u041d\u043d]\u0430\u043a\u043b\u0430\u0434\u043d\u0430\u044f\s+(\d{6,})/i,
    /(?:FBS|\u0424\u0411\u0421)\s+(\d{6,})/i,
    // Uzum FBS acceptance: "грузоместо 54013352387-1" -> invoice = 54013352387
    /\u0433\u0440\u0443\u0437\u043e\u043c\u0435\u0441\u0442\u043e\s+(\d{6,})(?:-\d+)?/i,
    /[\u2116#]\s*(\d{6,})/,
    /[\u2116#]\s*(\d{4,})/,
  ];
  ...
  const senderPatterns: RegExp[] = [
    /[\u041e\u043e]\u0442\u043f\u0440\u0430\u0432\u0438\u0442\u0435\u043b\u044c\s*:?\s*(.+?)(?:\s+[\u2116#]|\s+\u0434\u043e\u0433\u043e\u0432\u043e\u0440|\s+[\u041f\u043f]\u0443\u043d\u043a\u0442|\s+\u0433\u0440\u0443\u0437\u043e|\n|$)/i,
    /[\u041f\u043f]\u043e\u0441\u0442\u0430\u0432\u0449\u0438\u043a\s*:?\s*(.+?)(?:\s+\u0433\u0440\u0443\u0437\u043e|\n|$)/i,
    /[\u041f\u043f]\u0430\u0440\u0442\u043d\u0435\u0440\s*:?\s*(.+?)(?:\s+\u0433\u0440\u0443\u0437\u043e|\n|$)/i,
    /[\u041a\u043a]\u043e\u043c\u0438\u0441\u0441\u0438\u043e\u043d\u0435\u0440\s*:?\s*(.{3,60}?)(?:[\u041f\u043f]\u0440\u0438\u043d\u044f\u0442\u044b\u0435|\s{5,}|\s+\u0433\u0440\u0443\u0437\u043e|\n|$)/i,
    /[\u0417\u0437]\u0430\u043a\u0430\u0437\u0447\u0438\u043a\s*:?\s*(.{3,60}?)(?:\s+\u0433\u0440\u0443\u0437\u043e|\n|$)/i,
    /[\u041f\u043f]\u0440\u043e\u0434\u0430\u0432\u0435\u0446\s*:?\s*(.{3,60}?)(?:\s+\u0433\u0440\u0443\u0437\u043e|\n|$)/i,
    // ИП/ООО pattern: stop before digit, грузо, пункт, or FBS/номер keywords
    /(?:\u0418\u041f|\u041e\u041e\u041e|\u0427\u041f|\u0410\u041e|\u0418\u0423\u041f\u041f|\u0418\u0423\u041f)\s+([\u0400-\u04FF\u0041-\u005Aa-z]{2,}(?:\s+[\u0400-\u04FF\u0041-\u005Aa-z]{2,}){0,6})(?=\s+\d|\s+\u0433\u0440\u0443\u0437|\s+\u043f\u0443\u043d\u043a\u0442|\s+FBS|\s+\u043d\u043e\u043c\u0435\u0440|\n|$)/u,
  ];
